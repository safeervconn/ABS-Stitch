...
import { Shield, Users, ShoppingBag, Package, LogOut, Bell, TrendingUp, DollarSign, Eye, UserPlus, Settings } from 'lucide-react';
...
const AdminDashboard: React.FC = () => {
  ...
  const stats = [
    ...
    { title: 'Products', value: '89', change: '+3', icon: Package, color: 'purple' },
    { title: 'Revenue', value: '$24,580', change: '+18%', icon: DollarSign, color: 'orange' }
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Manage your business operations from this central dashboard.</p>
        </div>
