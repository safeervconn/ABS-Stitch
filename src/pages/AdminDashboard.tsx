...
import { Shield, Users, ShoppingBag, Package, LogOut, Bell, Plus, Eye, Edit, Trash2, UserPlus, Settings } from 'lucide-react';
...
const AdminDashboard: React.FC = () => {
  ...
  const { getOrdersByRole, updateOrderStatus, assignDesigner } = useOrders();
  ...
  const stats = [
    { title: 'Total Users', value: '156', change: '+12', icon: Users, color: 'blue' },
    { title: 'Active Orders', value: allOrders.filter(o => !['completed', 'delivered', 'cancelled'].includes(o.status)).length.toString(), change: '+8', icon: ShoppingBag, color: 'green' },
    { title: 'Products', value: '89', change: '+5', icon: Package, color: 'purple' },
    { title: 'Revenue', value: '$24,580', change: '+18%', icon: Shield, color: 'orange' }
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Manage users, orders, and system settings from here.</p>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100">
            ...
            <div className="p-6 space-y-4">
              ...
              <button className="w-full flex items-center space-x-3 p-4 bg-gradient-to-r from-purple-50 to-pink-50 hover:from-purple-100 hover:to-pink-100 rounded-lg transition-all text-left shadow-sm">
                ...
                <span className="font-medium text-gray-900">Order Reports</span>
              </button>
