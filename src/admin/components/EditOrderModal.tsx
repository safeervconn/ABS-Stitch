...
<div className="fixed inset-0 z-50 flex items-center justify-center p-4">
   <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
      ...
      <form onSubmit={handleSubmit} className="p-6">
         ...
         {/* Attachments Section */} <div className="mb-6"> <AttachmentList orderId={order.id} orderNumber={order.order_number} attachments={attachments} onAttachmentsChange={fetchAttachments} canUpload={!isFormDisabled} canDelete={canDeleteAttachment} pendingDeletions={pendingDeletions} onPendingDeletionsChange={setPendingDeletions} deferDeletion={true} onConfirmDelete={handleConfirmDelete} /> </div> </> )}
      {/* Actions */}
