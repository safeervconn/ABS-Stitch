                      ...
                      <ul className="space-y-3 sm:space-y-4 mb-8 flex-grow">
                        {pkg.features.map((feature, featureIndex) => (
                          <li key={featureIndex} className="flex items-start">
                            <div className={`flex-shrink-0 w-4 h-4 rounded-full flex items-center justify-center mr-4 mt-0.5 shadow-sm ${
                              feature.included 
                                ? 'bg-gradient-to-r from-green-500 to-emerald-600' 
                                : 'bg-gradient-to-r from-red-500 to-red-600'
                            }`}>
                              {feature.included ? (
                                <Check className="w-2 h-2 text-white font-bold" strokeWidth={3} aria-hidden="true" />
                              ) : (
                                <X className="w-2 h-2 text-white font-bold" strokeWidth={3} aria-hidden="true" />
                              )}
                            </div>
                            <div className="flex-grow">
                              <span className={`text-sm sm:text-base mobile-text font-semibold ${
                                feature.included 
                                  ...
                                  : 'text-black dark:text-black''opacity-90' : 'opacity-60'
                              }`}>
                                {feature.name}
                              </span>
