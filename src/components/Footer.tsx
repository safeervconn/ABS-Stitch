                ...
                {navItems.map((item) => (
                  <li key={item}>
                    <button
                      ...
                      className="text-slate-300 hover:text-blue-400 transition-colors duration-150 hover:translate-x-1 transform focus:outline-none focus:text-blue-400"
                    >
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:hello@techflowsolutions.com" className="text-slate-300 hover:text-blue-400 transition-colors">
