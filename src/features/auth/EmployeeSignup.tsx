/**
 * Employee Signup Page Component
 * 
 * Features:
 * - Self-registration for sales reps and designers only
 * - Same design pattern as customer signup
 * - Account created with disabled status pending admin approval
...
import { createEmployeeProfileSelfSignup } from '../../api/users';
...
const EmployeeSignup: React.FC = () => {
  const [formData, setFormData] = useState({
    ...
    password: '',
    confirmPassword: '',
    role: 'sales_rep' as 'sales_rep' | 'designer',
    acceptTerms: false
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (user) {
        ...
        try {
          // Create employee profile with disabled status
          const employeeData = {
            id: user.id,
          ...
          await createEmployeeProfileSelfSignup(employeeData);
        } catch (profileError) {
          ...
          <div className="glass rounded-2xl shadow-2xl p-8 text-center relative z-10">
            ...
            <div className="bg-blue-50 rounded-lg p-4 mb-6">
              <p className="text-sm text-blue-800">
                ...
                • You'll receive confirmation when your account is activated<br />
                • You can then sign in at the login page
              </p>
            </div>
            <button
      ...
      <div className="max-w-md w-full">
        ...
        <div className="glass rounded-2xl shadow-2xl p-8 relative z-10">
          ...
          <div className="mt-6 bg-blue-50 rounded-lg p-4">
            <p className="text-sm text-blue-800">
              <strong>Note:</strong> Your account will be reviewed and activated by an administrator. 
              You will not be able to sign in until your account is approved.
            </p>
          </div>
