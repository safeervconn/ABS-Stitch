...
const Login: React.FC = React.memo(() => {
  ...
  /**
   * Handle form submission with authentication and redirection
   */
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center py-12 px-4 relative overflow-hidden">
      {/* SEO Optimization */}
      <Helmet>
        <title>Sign In | ABS STITCH - Access Your Account</title>
        <meta name="description" content="Sign in to your ABS STITCH account to access your dashboard, manage orders, and track your custom embroidery projects." />
