 ...
 * - Responsive design showing 3-4 cards
...
const Testimonials: React.FC = React.memo(() => {
  ...
  const testimonials = useMemo(() => [
    {
      ...
      rating: 5,
      text: "ABS STITCH transformed my rough sketches into beautiful embroidery designs. The quality exceeded my expectations!"
    },
    {
      id: 2,
      name: "Mike Chen",
  ...
  const extendedTestimonials = useMemo(() => [...testimonials, ...testimonials], [testimonials]);
  
  const [currentOffset, setCurrentOffset] = useState(0);
  const cardWidth = 320; // Width of each card including margin

  /**
   * Auto-slide effect with optimized performance
   */
  useEffect(() => {
    ...
    <section className="py-16 bg-gradient-to-b from-white to-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="relative overflow-hidden">
          <div 
            className="flex transition-transform duration-1000 ease-in-out gpu-accelerated"
            style={{ 
              transform: `translate3d(-${currentOffset * cardWidth}px, 0, 0)`,
