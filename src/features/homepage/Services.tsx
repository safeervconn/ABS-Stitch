 ...
 * 
 * Displays company service offerings with:
...
const Services: React.FC = React.memo(() => {
  /**
   * Services configuration with icons and descriptions
   */
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => {
            ...
            return (
              <div 
                key={service.id} 
                className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100 hover:border-gray-200 card-hover"
